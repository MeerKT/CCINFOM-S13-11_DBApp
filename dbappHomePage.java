...
public class dbappHomePage {
    public static void main(String[] args) {
        ...
        JPanel hireTerminateTransferPanel = createHireTerminateTransferPanel(mainPanel); // New intermediate panel
        ...
        JPanel changeStatusPanel = createChangeStatusPanel(mainPanel); // New Panel
    ...
    private static JPanel createMainMenu(JPanel mainPanel) {
        ...
        reportsPanel.add(new JButton("Generate Attendance Report"));
        reportsPanel.add(new JButton("Generate Salary Report per Year"));
        reportsPanel.add(new JButton("Generate Performance Report per Year"));
        reportsPanel.add(new JButton("Generate Hires and Attrition Report"));
